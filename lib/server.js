...
app.get("/v1/explorers/:mission", (request, response) => {
    ...
    const explorersInMission = ExplorerController.filterExplorersByMission(mission);
...
app.get("/v1/fizzbuzz/:score", (request, response) => {
    ...
    const FizzBuzzString = ExplorerController.applyValidationInNumber(score);
    response.json({score: score, trick: FizzBuzzString});
});